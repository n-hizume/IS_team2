        ...
        <div class="flex">  
            <SideMenu/>
                ...
                <div class="mail-box m-3 rounded-2xl flex">
                  <div class="allmail">
                      <div class="mt-3 ml-3 mr-3 text-start pl-4 font-bold text-primary-600">
                          <p>通知</p>
                          <div clsss="flex ">
                              <div class="mail my-2 rounded-2xl"></div>
                              <div class="mail my-2 rounded-2xl"></div>
                              <div class="mail my-2 rounded-2xl"></div>
                              <div class="mail my-2 rounded-2xl"></div>
                              <div class="mail my-2 rounded-2xl"></div>
                  ...
                  <div id="WriteView" class="w-full">
                      <div class="flex-container">
                          <!--メール詳細-->
                          <div class="right ml-2 mr-2 mt-5 mb-2 rounded-2xl">
