      ...
      <div class="flex">  
          <SideMenu/>
              ...
              <div class="mail-box m-3 rounded-2xl flex">
                <div class="allmail">
                    <div class="mt-3 ml-4 mr-3 text-start pl-4 font-bold text-primary-600">
                        <p>受信箱</p>
                    </div>  
                    <div class="mt-1.5 ml-6">
                        <button class="mail my-0.5 rounded-2xl cursor-pointer"></button>
                        <button class="mail my-0.5 rounded-2xl cursor-pointer"></button>
                        <button class="mail my-0.5 rounded-2xl cursor-pointer"></button>
                        <button class="mail my-0.5 rounded-2xl cursor-pointer"></button>
                        <button class="mail my-0.5 rounded-2xl cursor-pointer"></button>
                ...
                <div id="WriteView" class="w-full">
                    <div class="flex-container">
                        <!--メール詳細-->
                        <div class="right ml-3 mr-4 mt-5 mb-2 rounded-2xl">

                            <!--メール詳細top-->
                            <div class="right-top flex">
                                <div class="ml-auto mr-3 mt-0.5">
                                    <SettingInformation/>
                                </div>    
                        ...
                        <div class="write ml-3 mr-4 ">

                            <!--メール詳細top-->
                            <div class="write2-top flex items-center ml-2flex justify-between w-full text-sm px-3.5 py-2.5 bg-gray-200">
                                <Reply :size="20" />
                            </div>

                            
                            <textarea id="textatra1" name="textarea" v-model="body" style="resize:none;" class="w-full 
                                    border-transparent 
                                    border-none 
                                    focus:ring-0 
                                    outline-none
                            ...
                            <div class="write2-b flex">
                                ...
                                <button @click="moveemailScreen" class="mt-2 ml-auto mr-3">
                                    <WindowClose :size="20"/>
                                </button>
                            </div>  
                        </div> 
